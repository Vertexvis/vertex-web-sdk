...
declare global {
  ...
  interface HTMLVertexDocumentViewerElement extends Components.VertexDocumentViewer, HTMLStencilElement {
    addEventListener<K extends keyof HTMLVertexDocumentViewerElementEventMap>(
      type: K,
      listener: (this: HTMLVertexDocumentViewerElement, ev: VertexDocumentViewerCustomEvent<HTMLVertexDocumentViewerElementEventMap[K]>) => any,
    ...
    removeEventListener<K extends keyof HTMLVertexDocumentViewerElementEventMap>(
      type: K,
      listener: (this: HTMLVertexDocumentViewerElement, ev: VertexDocumentViewerCustomEvent<HTMLVertexDocumentViewerElementEventMap[K]>) => any,
...
declare namespace LocalJSX {
  ...
  interface IntrinsicElements {
    'vertex-document-viewer': Omit<VertexDocumentViewer, keyof VertexDocumentViewerAttributes> & {
      [K in keyof VertexDocumentViewer & keyof VertexDocumentViewerAttributes]?: VertexDocumentViewer[K];
    } & { [K in keyof VertexDocumentViewer & keyof VertexDocumentViewerAttributes as `attr:${K}`]?: VertexDocumentViewerAttributes[K] } & {
      [K in keyof VertexDocumentViewer & keyof VertexDocumentViewerAttributes as `prop:${K}`]?: VertexDocumentViewer[K];
    };
  }
}
