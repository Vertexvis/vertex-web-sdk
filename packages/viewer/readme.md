...
<html>
  <head>
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@vertexvis/viewer@0.24.0/dist/viewer/viewer.css"
    />
    <script
      type="module"
      src="https://cdn.jsdelivr.net/npm/@vertexvis/viewer@0.24.0/dist/viewer/viewer.esm.js"
    ></script>
  </head>
...
<html>
  ...
  <body>
    <script type="module">
      import { ColorMaterial } from 'https://cdn.jsdelivr.net/npm/@vertexvis/viewer@0.24.0/dist/esm/index.mjs';
