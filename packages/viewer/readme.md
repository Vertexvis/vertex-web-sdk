...
<html>
  <head>
    <link
      rel="stylesheet"
      href="https://unpkg.com/@vertexvis/viewer@0.19.1/dist/viewer/viewer.css"
    />
    <script
      type="module"
      src="https://unpkg.com/@vertexvis/viewer@0.19.1/dist/viewer/viewer.esm.js"
    ></script>
  </head>
...
<html>
  ...
  <body>
    <script type="module">
      import { ColorMaterial } from 'https://unpkg.com/@vertexvis/viewer@0.19.1/dist/esm/index.mjs';
