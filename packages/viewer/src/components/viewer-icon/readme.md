...
| -------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `name`   | `name`    | The name of the icon to render.                                                                                                                                                                                                                                      | `"chevron-down" \| "chevron-left" \| "chevron-right" \| "close-circle" \| "eye-half" \| "eye-half-dotted" \| "eye-open" \| "fit-all" \| "pin-fill" \| "search" \| undefined` | `undefined` |
