...
| -------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `name`   | `name`    | The name of the icon to render.                                                                                                                                                                                                                                      | `"chevron-down" \| "chevron-right" \| "close-circle" \| "comment-show" \| "eye-half" \| "eye-half-dotted" \| "eye-open" \| "fit-all" \| "pin-fill" \| "search" \| undefined` | `undefined` |
