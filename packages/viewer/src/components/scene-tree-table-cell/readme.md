...
| -------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `disableAltKeySelection`         | `disable-alt-key-selection`         | A flag that disables selection if the Alt (or Option on Mac) key is held down. When enabled, selection will occur as though no modifier keys are pressed.                                                                                  | `boolean`                                                                                                                                                                                                                                                      | `false`     |
