...
| `experimentalConnectWhileHidden` | `experimental-connect-while-hidden` | Experimental flag indicating that connections to Vertex should be established if the viewer has its visibility set to `hidden`.  *Caution:* Setting this flag can result in reduced performance, and should not be used in a production setting.                                                                                                                                                                                                                                                                                                                       | `boolean`                                   | `false`                                            |
