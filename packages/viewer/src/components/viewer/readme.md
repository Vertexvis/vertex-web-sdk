...
| `tokenExpired`           | <span style="color:red">**[DEPRECATED]**</span> Token refresh is handled automatically internally; no replacement is needed<br/><br/>Emits an event when a provided oauth2 token is about to expire, or is about to expire, causing issues with establishing a websocket connection, or performing API calls. | `CustomEvent<void>`                                                                                |
