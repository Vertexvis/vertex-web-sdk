...
| `phantomOpacity`              | `phantom-opacity`               | Specifies the opacity, between 0 and 1, for a phantom feature, where 0 is completely hidden and 1 is completely visible.                                                                                                                                                                                                                                                                                                                                                                                                                                            | `number`                                    | `0.5`                                              |
