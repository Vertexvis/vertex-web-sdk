...
| `"retry"` | A slot that replaces the default Retry button displayed when the viewer fails to connect. If slotted, the element is expected to handle the retry logic. |
