...
| --------------- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | ---------------- |
| `accentColor`   | `accent-color`  | The accent color for new pins. Setting this will override the template color to set pins created with this color to this specified color. This is used as a complimentary color to the primary color. | `Color \| string \| undefined`         | `undefined`      |
...
| `primaryColor`  | `primary-color` | The primary color for new pins. Setting this will override the template color to set pins created with this color to this specified color. This styling applies to pin anchors, and borders, etc.     | `Color \| string \| undefined`         | `undefined`      |
