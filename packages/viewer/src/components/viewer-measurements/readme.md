...
| `measurementModel`       | --                          | The measurement model that will be updated with the selected measurement. You can pass this to a <vertex-viewer-measurement-details> component to display measurement outcomes. | `MeasurementModel`                                                            | `new MeasurementModel()`    |
| `selectedMeasurementId`  | `selected-measurement-id`   | The ID of the measurement that is selected.                                                                                                                                     | `string \| undefined`                                                         | `undefined`                 |
| `showAxisReferenceLines` | `show-axis-reference-lines` | Enables the display of axis reference lines between the start and end point of selected measurements.                                                                           | `boolean`                                                                     | `false`                     |
