...
| `degreeToSnapToWhenRotating`   | `degree-to-snap-to-when-rotating`          | When defined, the widget will snap to the degree of the nearest multiple of the given number when the user is rotating with the widget and holding the shift key. Defaults to undefined. | `number \| undefined`                                                         | `undefined`     |
