...
| `interactionDebounce`          | `interaction-debounce`                     | Specifies the delay, in milliseconds, to update the transform after interactions with the widget.  This delay is used to group events happening in quick succession and results in smoother widget movement.                                    | `number`                                                                      | `75`            |
