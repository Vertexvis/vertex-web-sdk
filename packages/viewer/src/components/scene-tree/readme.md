...
| `metadataSearchKeys`       | --                            | <span style="color:red">**[DEPRECATED]**</span> Use `searchOptions` A list of the metadata keys that a scene tree search should be performed on.<br/><br/>          | `string[] \| undefined`                                | `undefined`  |
