...
| `metadataSearchRemoveHiddenItems` | `metadata-search-remove-hidden-items` | Indicates whether the metadata search should remove hidden items from the results.                                                                                  | `boolean`                                              | `false`      |
