...
| `position`     | --              | The 3D position where this element is located.                                                                                           | `Vector3`    | `Vector3.origin()`        |
| `quaternion`   | --              | The rotation of this this element, represented as a Quaternion.                                                                          | `Quaternion` | `Quaternion.create()`     |
| `scale`        | --              | The scale of this element.                                                                                                               | `Vector3`    | `Vector3.create(1, 1, 1)` |
| `up`           | --              | The direction which this object considers up.                                                                                            | `Vector3`    | `Vector3.up()`            |
...
| ---------------- | ------------------------------------------------------------------- | ------------------- |
| `propertyChange` | An event that is emitted when a property of this component changes. | `CustomEvent<void>` |
