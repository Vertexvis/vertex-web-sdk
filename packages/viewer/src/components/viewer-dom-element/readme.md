...
| `detached`        | `detached`         | **EXPERIMENTAL** Indicates if the element is detached from geometry. This property can be used with a CSS selector to modify the appearance of the element when it's detached.                                                                  | `boolean`                                                                                                                          | `false`                   |
