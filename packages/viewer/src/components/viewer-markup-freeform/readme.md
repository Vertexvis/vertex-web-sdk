...
| `markupUpdated` | An event that is dispatched with the updated markup element after the markup has changed.                               | `CustomEvent<HTMLVertexViewerMarkupFreeformElement>` |
