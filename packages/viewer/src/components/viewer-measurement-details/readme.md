...
| `areaUnits`         | `area-units`        | The unit of area-based measurement.                                                                                                                                                                                                                                           | `"cm<sup>2</sup>" \| "ft<sup>2</sup>" \| "in<sup>2</sup>" \| "m<sup>2</sup>" \| "mm<sup>2</sup>" \| "yd<sup>2</sup>"` | `'mm<sup>2</sup>'`       |
...
| `hiddenDetails`     | --                  | An optional set of details to hide. This can be used to display reduced sets of details for more a more focused representation. Can be provided as an array of keys from the `MeasurementDetailsSummary` type, or as a JSON array with the format '["angle", "minDistance"]'. | `(keyof MeasurementDetailsSummary)[] \| undefined`                                                                    | `undefined`              |
...
| `results`           | --                  | The current `MeasurementResult` displayed.                                                                                                                                                                                                                                    | `MeasurementResult[]`                                                                                                 | `[]`                     |
| `summary`           | --                  | A summary representing all available measurements based on the current `MeasurementResult` set.                                                                                                                                                                               | `MeasurementDetailsSummary \| undefined`                                                                              | `undefined`              |
