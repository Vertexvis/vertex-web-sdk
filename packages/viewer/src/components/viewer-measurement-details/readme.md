...
| `summary`           | --                  | A summary representing all available measurements based on the current `MeasurementResult` set.                                                                                                                                                                                     | `ViewerMeasurementDetailsSummary \| undefined`                                | `undefined`              |
| `visibleSummary`    | --                  | The visible measurements based on the current `summary` and `hiddenDetails`.                                                                                                                                                                                                        | `ViewerMeasurementDetailsSummary \| undefined`                                | `undefined`              |
