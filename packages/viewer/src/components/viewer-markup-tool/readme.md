...
| `endLineEndStyle`    | `end-line-end-style`   | The line end style of the ending anchor. This default to 'arrow-triangle.'                                                                             | `"arrow-line" \| "arrow-triangle" \| "dot" \| "hash" \| "none"` | `'arrow-triangle'` |
...
| `startLineEndStyle`  | `start-line-end-style` | The line end style of the starting anchor. This default to none.                                                                                       | `"arrow-line" \| "arrow-triangle" \| "dot" \| "hash" \| "none"` | `'none'`           |
