...
declare global {
  ...
  interface HTMLVertexViewerThreejsRendererElement
    extends Components.VertexViewerThreejsRenderer,
      HTMLStencilElement {}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'vertex-viewer-threejs-renderer': LocalJSX.VertexViewerThreejsRenderer &
        JSXBase.HTMLAttributes<HTMLVertexViewerThreejsRendererElement>;
