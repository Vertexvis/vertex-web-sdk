...
import { RowArg, RowDataProvider, SceneTreeOperationOptions, ScrollToOptions, SelectItemOptions } from "./components/scene-tree/scene-tree";
...
import { FeatureHighlightOptions, FeatureLineOptions, FrameType } from "./interfaces";
...
declare global {
    ...
    interface HTMLVertexViewerIntersectionQueryToolElement extends Components.VertexViewerIntersectionQueryTool, HTMLStencilElement {
    }
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "vertex-viewer-intersection-query-tool": LocalJSX.VertexViewerIntersectionQueryTool & JSXBase.HTMLAttributes<HTMLVertexViewerIntersectionQueryToolElement>;
