...
declare global {
  ...
  interface HTMLVertexSceneTreeTableElement
    extends Components.VertexSceneTreeTable,
      HTMLStencilElement {}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'vertex-scene-tree-table': LocalJSX.VertexSceneTreeTable &
        JSXBase.HTMLAttributes<HTMLVertexSceneTreeTableElement>;
