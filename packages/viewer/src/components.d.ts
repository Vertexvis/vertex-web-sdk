...
declare namespace LocalJSX {
  ...
  interface IntrinsicElements {
    ...
    > & {
      [
        K in keyof VertexSceneTree & keyof VertexSceneTreeAttributes
      ]?: VertexSceneTree[K];
    } & {
      [
        K in keyof VertexSceneTree &
          keyof VertexSceneTreeAttributes as `attr:${K}`
      ]?: VertexSceneTreeAttributes[K];
    } & {
      [
        K in keyof VertexSceneTree &
          keyof VertexSceneTreeAttributes as `prop:${K}`
      ]?: VertexSceneTree[K];
    };
    ...
    > & {
      [
        K in keyof VertexSceneTreeNotificationBanner &
          keyof VertexSceneTreeNotificationBannerAttributes
      ]?: VertexSceneTreeNotificationBanner[K];
    } & {
      [
        K in keyof VertexSceneTreeNotificationBanner &
          keyof VertexSceneTreeNotificationBannerAttributes as `attr:${K}`
      ]?: VertexSceneTreeNotificationBannerAttributes[K];
    } & {
      [
        K in keyof VertexSceneTreeNotificationBanner &
          keyof VertexSceneTreeNotificationBannerAttributes as `prop:${K}`
      ]?: VertexSceneTreeNotificationBanner[K];
    };
    ...
    > & {
      [
        K in keyof VertexSceneTreeSearch & keyof VertexSceneTreeSearchAttributes
      ]?: VertexSceneTreeSearch[K];
    } & {
      [
        K in keyof VertexSceneTreeSearch &
          keyof VertexSceneTreeSearchAttributes as `attr:${K}`
      ]?: VertexSceneTreeSearchAttributes[K];
    } & {
      [
        K in keyof VertexSceneTreeSearch &
          keyof VertexSceneTreeSearchAttributes as `prop:${K}`
      ]?: VertexSceneTreeSearch[K];
    };
    ...
    > & {
      [
        K in keyof VertexSceneTreeTableCell &
          keyof VertexSceneTreeTableCellAttributes
      ]?: VertexSceneTreeTableCell[K];
    } & {
      [
        K in keyof VertexSceneTreeTableCell &
          keyof VertexSceneTreeTableCellAttributes as `attr:${K}`
      ]?: VertexSceneTreeTableCellAttributes[K];
    } & {
      [
        K in keyof VertexSceneTreeTableCell &
          keyof VertexSceneTreeTableCellAttributes as `prop:${K}`
      ]?: VertexSceneTreeTableCell[K];
    };
    ...
    > & {
      [
        K in keyof VertexSceneTreeTableColumn &
          keyof VertexSceneTreeTableColumnAttributes
      ]?: VertexSceneTreeTableColumn[K];
    } & {
      [
        K in keyof VertexSceneTreeTableColumn &
          keyof VertexSceneTreeTableColumnAttributes as `attr:${K}`
      ]?: VertexSceneTreeTableColumnAttributes[K];
    } & {
      [
        K in keyof VertexSceneTreeTableColumn &
          keyof VertexSceneTreeTableColumnAttributes as `prop:${K}`
      ]?: VertexSceneTreeTableColumn[K];
    };
    ...
    > & {
      [
        K in keyof VertexSceneTreeTableLayout &
          keyof VertexSceneTreeTableLayoutAttributes
      ]?: VertexSceneTreeTableLayout[K];
    } & {
      [
        K in keyof VertexSceneTreeTableLayout &
          keyof VertexSceneTreeTableLayoutAttributes as `attr:${K}`
      ]?: VertexSceneTreeTableLayoutAttributes[K];
    } & {
      [
        K in keyof VertexSceneTreeTableLayout &
          keyof VertexSceneTreeTableLayoutAttributes as `prop:${K}`
      ]?: VertexSceneTreeTableLayout[K];
    };
    ...
    'vertex-viewer': Omit<VertexViewer, keyof VertexViewerAttributes> & {
      [
        K in keyof VertexViewer & keyof VertexViewerAttributes
      ]?: VertexViewer[K];
    } & {
      [
        K in keyof VertexViewer & keyof VertexViewerAttributes as `attr:${K}`
      ]?: VertexViewerAttributes[K];
    } & {
      [
        K in keyof VertexViewer & keyof VertexViewerAttributes as `prop:${K}`
      ]?: VertexViewer[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerAnnotationCallout &
          keyof VertexViewerAnnotationCalloutAttributes
      ]?: VertexViewerAnnotationCallout[K];
    } & {
      [
        K in keyof VertexViewerAnnotationCallout &
          keyof VertexViewerAnnotationCalloutAttributes as `attr:${K}`
      ]?: VertexViewerAnnotationCalloutAttributes[K];
    } & {
      [
        K in keyof VertexViewerAnnotationCallout &
          keyof VertexViewerAnnotationCalloutAttributes as `prop:${K}`
      ]?: VertexViewerAnnotationCallout[K];
    };
    ...
    > & {
      ...
      [
        K in keyof VertexViewerBoxQueryTool &
          keyof VertexViewerBoxQueryToolAttributes as `attr:${K}`
      ]?: VertexViewerBoxQueryToolAttributes[K];
    } & {
      [
        K in keyof VertexViewerBoxQueryTool &
    ...
    > & {
      [
        K in keyof VertexViewerDefaultToolbar &
          keyof VertexViewerDefaultToolbarAttributes
      ]?: VertexViewerDefaultToolbar[K];
    } & {
      [
        K in keyof VertexViewerDefaultToolbar &
          keyof VertexViewerDefaultToolbarAttributes as `attr:${K}`
      ]?: VertexViewerDefaultToolbarAttributes[K];
    } & {
      [
        K in keyof VertexViewerDefaultToolbar &
          keyof VertexViewerDefaultToolbarAttributes as `prop:${K}`
      ]?: VertexViewerDefaultToolbar[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerDomElement &
          keyof VertexViewerDomElementAttributes
      ]?: VertexViewerDomElement[K];
    } & {
      [
        K in keyof VertexViewerDomElement &
          keyof VertexViewerDomElementAttributes as `attr:${K}`
      ]?: VertexViewerDomElementAttributes[K];
    } & {
      [
        K in keyof VertexViewerDomElement &
          keyof VertexViewerDomElementAttributes as `prop:${K}`
      ]?: VertexViewerDomElement[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerDomGroup & keyof VertexViewerDomGroupAttributes
      ]?: VertexViewerDomGroup[K];
    } & {
      [
        K in keyof VertexViewerDomGroup &
          keyof VertexViewerDomGroupAttributes as `attr:${K}`
      ]?: VertexViewerDomGroupAttributes[K];
    } & {
      [
        K in keyof VertexViewerDomGroup &
          keyof VertexViewerDomGroupAttributes as `prop:${K}`
      ]?: VertexViewerDomGroup[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerDomRenderer &
          keyof VertexViewerDomRendererAttributes
      ]?: VertexViewerDomRenderer[K];
    } & {
      [
        K in keyof VertexViewerDomRenderer &
          keyof VertexViewerDomRendererAttributes as `attr:${K}`
      ]?: VertexViewerDomRendererAttributes[K];
    } & {
      [
        K in keyof VertexViewerDomRenderer &
          keyof VertexViewerDomRendererAttributes as `prop:${K}`
      ]?: VertexViewerDomRenderer[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerIcon & keyof VertexViewerIconAttributes
      ]?: VertexViewerIcon[K];
    } & {
      [
        K in keyof VertexViewerIcon &
          keyof VertexViewerIconAttributes as `attr:${K}`
      ]?: VertexViewerIconAttributes[K];
    } & {
      [
        K in keyof VertexViewerIcon &
          keyof VertexViewerIconAttributes as `prop:${K}`
      ]?: VertexViewerIcon[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerLayer & keyof VertexViewerLayerAttributes
      ]?: VertexViewerLayer[K];
    } & {
      [
        K in keyof VertexViewerLayer &
          keyof VertexViewerLayerAttributes as `attr:${K}`
      ]?: VertexViewerLayerAttributes[K];
    } & {
      [
        K in keyof VertexViewerLayer &
          keyof VertexViewerLayerAttributes as `prop:${K}`
      ]?: VertexViewerLayer[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMarkup & keyof VertexViewerMarkupAttributes
      ]?: VertexViewerMarkup[K];
    } & {
      [
        K in keyof VertexViewerMarkup &
          keyof VertexViewerMarkupAttributes as `attr:${K}`
      ]?: VertexViewerMarkupAttributes[K];
    } & {
      [
        K in keyof VertexViewerMarkup &
          keyof VertexViewerMarkupAttributes as `prop:${K}`
      ]?: VertexViewerMarkup[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMarkupArrow &
          keyof VertexViewerMarkupArrowAttributes
      ]?: VertexViewerMarkupArrow[K];
    } & {
      [
        K in keyof VertexViewerMarkupArrow &
          keyof VertexViewerMarkupArrowAttributes as `attr:${K}`
      ]?: VertexViewerMarkupArrowAttributes[K];
    } & {
      [
        K in keyof VertexViewerMarkupArrow &
          keyof VertexViewerMarkupArrowAttributes as `prop:${K}`
      ]?: VertexViewerMarkupArrow[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMarkupCircle &
          keyof VertexViewerMarkupCircleAttributes
      ]?: VertexViewerMarkupCircle[K];
    } & {
      [
        K in keyof VertexViewerMarkupCircle &
          keyof VertexViewerMarkupCircleAttributes as `attr:${K}`
      ]?: VertexViewerMarkupCircleAttributes[K];
    } & {
      [
        K in keyof VertexViewerMarkupCircle &
          keyof VertexViewerMarkupCircleAttributes as `prop:${K}`
      ]?: VertexViewerMarkupCircle[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMarkupFreeform &
          keyof VertexViewerMarkupFreeformAttributes
      ]?: VertexViewerMarkupFreeform[K];
    } & {
      [
        K in keyof VertexViewerMarkupFreeform &
          keyof VertexViewerMarkupFreeformAttributes as `attr:${K}`
      ]?: VertexViewerMarkupFreeformAttributes[K];
    } & {
      [
        K in keyof VertexViewerMarkupFreeform &
          keyof VertexViewerMarkupFreeformAttributes as `prop:${K}`
      ]?: VertexViewerMarkupFreeform[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMarkupTool &
          keyof VertexViewerMarkupToolAttributes
      ]?: VertexViewerMarkupTool[K];
    } & {
      [
        K in keyof VertexViewerMarkupTool &
          keyof VertexViewerMarkupToolAttributes as `attr:${K}`
      ]?: VertexViewerMarkupToolAttributes[K];
    } & {
      [
        K in keyof VertexViewerMarkupTool &
          keyof VertexViewerMarkupToolAttributes as `prop:${K}`
      ]?: VertexViewerMarkupTool[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMeasurementDetails &
          keyof VertexViewerMeasurementDetailsAttributes
      ]?: VertexViewerMeasurementDetails[K];
    } & {
      [
        K in keyof VertexViewerMeasurementDetails &
          keyof VertexViewerMeasurementDetailsAttributes as `attr:${K}`
      ]?: VertexViewerMeasurementDetailsAttributes[K];
    } & {
      [
        K in keyof VertexViewerMeasurementDetails &
          keyof VertexViewerMeasurementDetailsAttributes as `prop:${K}`
      ]?: VertexViewerMeasurementDetails[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMeasurementDistance &
          keyof VertexViewerMeasurementDistanceAttributes
      ]?: VertexViewerMeasurementDistance[K];
    } & {
      [
        K in keyof VertexViewerMeasurementDistance &
          keyof VertexViewerMeasurementDistanceAttributes as `attr:${K}`
      ]?: VertexViewerMeasurementDistanceAttributes[K];
    } & {
      [
        K in keyof VertexViewerMeasurementDistance &
          keyof VertexViewerMeasurementDistanceAttributes as `prop:${K}`
      ]?: VertexViewerMeasurementDistance[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMeasurementLine &
          keyof VertexViewerMeasurementLineAttributes
      ]?: VertexViewerMeasurementLine[K];
    } & {
      [
        K in keyof VertexViewerMeasurementLine &
          keyof VertexViewerMeasurementLineAttributes as `attr:${K}`
      ]?: VertexViewerMeasurementLineAttributes[K];
    } & {
      [
        K in keyof VertexViewerMeasurementLine &
          keyof VertexViewerMeasurementLineAttributes as `prop:${K}`
      ]?: VertexViewerMeasurementLine[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerMeasurementPrecise &
          keyof VertexViewerMeasurementPreciseAttributes
      ]?: VertexViewerMeasurementPrecise[K];
    } & {
      [
        K in keyof VertexViewerMeasurementPrecise &
          keyof VertexViewerMeasurementPreciseAttributes as `attr:${K}`
      ]?: VertexViewerMeasurementPreciseAttributes[K];
    } & {
      [
        K in keyof VertexViewerMeasurementPrecise &
          keyof VertexViewerMeasurementPreciseAttributes as `prop:${K}`
      ]?: VertexViewerMeasurementPrecise[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerPinGroup & keyof VertexViewerPinGroupAttributes
      ]?: VertexViewerPinGroup[K];
    } & {
      [
        K in keyof VertexViewerPinGroup &
          keyof VertexViewerPinGroupAttributes as `attr:${K}`
      ]?: VertexViewerPinGroupAttributes[K];
    } & {
      [
        K in keyof VertexViewerPinGroup &
          keyof VertexViewerPinGroupAttributes as `prop:${K}`
      ]?: VertexViewerPinGroup[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerPinLabel & keyof VertexViewerPinLabelAttributes
      ]?: VertexViewerPinLabel[K];
    } & {
      [
        K in keyof VertexViewerPinLabel &
          keyof VertexViewerPinLabelAttributes as `attr:${K}`
      ]?: VertexViewerPinLabelAttributes[K];
    } & {
      [
        K in keyof VertexViewerPinLabel &
          keyof VertexViewerPinLabelAttributes as `prop:${K}`
      ]?: VertexViewerPinLabel[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerPinTool & keyof VertexViewerPinToolAttributes
      ]?: VertexViewerPinTool[K];
    } & {
      [
        K in keyof VertexViewerPinTool &
          keyof VertexViewerPinToolAttributes as `attr:${K}`
      ]?: VertexViewerPinToolAttributes[K];
    } & {
      [
        K in keyof VertexViewerPinTool &
          keyof VertexViewerPinToolAttributes as `prop:${K}`
      ]?: VertexViewerPinTool[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerSpinner & keyof VertexViewerSpinnerAttributes
      ]?: VertexViewerSpinner[K];
    } & {
      [
        K in keyof VertexViewerSpinner &
          keyof VertexViewerSpinnerAttributes as `attr:${K}`
      ]?: VertexViewerSpinnerAttributes[K];
    } & {
      [
        K in keyof VertexViewerSpinner &
          keyof VertexViewerSpinnerAttributes as `prop:${K}`
      ]?: VertexViewerSpinner[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerTeleportTool &
          keyof VertexViewerTeleportToolAttributes
      ]?: VertexViewerTeleportTool[K];
    } & {
      [
        K in keyof VertexViewerTeleportTool &
          keyof VertexViewerTeleportToolAttributes as `attr:${K}`
      ]?: VertexViewerTeleportToolAttributes[K];
    } & {
      [
        K in keyof VertexViewerTeleportTool &
          keyof VertexViewerTeleportToolAttributes as `prop:${K}`
      ]?: VertexViewerTeleportTool[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerToolbar & keyof VertexViewerToolbarAttributes
      ]?: VertexViewerToolbar[K];
    } & {
      [
        K in keyof VertexViewerToolbar &
          keyof VertexViewerToolbarAttributes as `attr:${K}`
      ]?: VertexViewerToolbarAttributes[K];
    } & {
      [
        K in keyof VertexViewerToolbar &
          keyof VertexViewerToolbarAttributes as `prop:${K}`
      ]?: VertexViewerToolbar[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerToolbarGroup &
          keyof VertexViewerToolbarGroupAttributes
      ]?: VertexViewerToolbarGroup[K];
    } & {
      [
        K in keyof VertexViewerToolbarGroup &
          keyof VertexViewerToolbarGroupAttributes as `attr:${K}`
      ]?: VertexViewerToolbarGroupAttributes[K];
    } & {
      [
        K in keyof VertexViewerToolbarGroup &
          keyof VertexViewerToolbarGroupAttributes as `prop:${K}`
      ]?: VertexViewerToolbarGroup[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerTransformWidget &
          keyof VertexViewerTransformWidgetAttributes
      ]?: VertexViewerTransformWidget[K];
    } & {
      [
        K in keyof VertexViewerTransformWidget &
          keyof VertexViewerTransformWidgetAttributes as `attr:${K}`
      ]?: VertexViewerTransformWidgetAttributes[K];
    } & {
      [
        K in keyof VertexViewerTransformWidget &
          keyof VertexViewerTransformWidgetAttributes as `prop:${K}`
      ]?: VertexViewerTransformWidget[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerViewCube & keyof VertexViewerViewCubeAttributes
      ]?: VertexViewerViewCube[K];
    } & {
      [
        K in keyof VertexViewerViewCube &
          keyof VertexViewerViewCubeAttributes as `attr:${K}`
      ]?: VertexViewerViewCubeAttributes[K];
    } & {
      [
        K in keyof VertexViewerViewCube &
          keyof VertexViewerViewCubeAttributes as `prop:${K}`
      ]?: VertexViewerViewCube[K];
    };
    ...
    > & {
      [
        K in keyof VertexViewerWalkModeTool &
          keyof VertexViewerWalkModeToolAttributes
      ]?: VertexViewerWalkModeTool[K];
    } & {
      [
        K in keyof VertexViewerWalkModeTool &
          keyof VertexViewerWalkModeToolAttributes as `attr:${K}`
      ]?: VertexViewerWalkModeToolAttributes[K];
    } & {
      [
        K in keyof VertexViewerWalkModeTool &
          keyof VertexViewerWalkModeToolAttributes as `prop:${K}`
      ]?: VertexViewerWalkModeTool[K];
    };
  }
}
