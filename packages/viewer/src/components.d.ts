...
import { FeatureHighlightOptions, FeatureLineOptions, FrameType, PhantomOptions, SelectionHighlightingOptions } from "./interfaces";
...
export interface VertexViewerAnnotationCalloutCustomEvent<T> extends CustomEvent<T> {
    detail: T;
...
declare namespace LocalJSX {
    ...
    interface VertexViewerAnnotationCallout {
         ...
         */
        "onOcclusionStateChange"?: (event: VertexViewerAnnotationCalloutCustomEvent<boolean>) => void;
        /**
          * The viewer synced to this renderer.
         */
        "viewer"?: HTMLVertexViewerElement;
