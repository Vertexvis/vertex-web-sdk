...
export namespace Components {
  ...
  interface VertexViewerPinTool {
    /**
     * The accent color for new pins. Setting this will override the template color to set pins created with this color to this specified color. This is used as a complimentary color to the primary color.
     */
    ...
    pinModel: PinModel;
    /**
     * The primary color for new pins. Setting this will override the template color to set pins created with this color to this specified color. This styling applies to pin anchors, and borders, etc.
     */
