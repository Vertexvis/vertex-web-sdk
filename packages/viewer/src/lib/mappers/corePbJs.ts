...
export const fromPbJsUuid2l: M.Func<vertexvis.protobuf.core.IUuid2l, UUID.UUID> =
  M.defineMapper(M.read(M.requiredProp('msb'), M.requiredProp('lsb')), ([msb, lsb]) => {
...
export const toPbJsUuid2l: M.Func<string, vertexvis.protobuf.core.IUuid2l> =
  M.defineMapper(
    M.compose(
      ...
      M.read(M.mapProp('msb', Long.fromString), M.mapProp('lsb', Long.fromString)),
    ),
    ([msb, lsb]) => ({ msb, lsb }),
  );
