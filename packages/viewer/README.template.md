...
<html>
  ...
  <body>
    <script type="module">
      import { ColorMaterial } from 'https://unpkg.com/@vertexvis/viewer@{{version}}/dist/viewer/viewer.esm.js';
...
<html>
  <head>
    <script
      nomodule
      src="https://unpkg.com/@vertexvis/viewer@{{version}}/dist/cdn/bundle.umd.js"
    ></script>
  </head>
  <body>
    <script>
