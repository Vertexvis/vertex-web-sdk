...
<html>
  <head>
    <link
      rel="stylesheet"
      href="https://unpkg.com/@vertexvis/poc-viewer@{{version}}/dist/viewer/viewer.css"
    />
    <script
      type="module"
      src="https://unpkg.com/@vertexvis/poc-viewer@{{version}}/dist/viewer/viewer.esm.js"
    ></script>
    <script
      nomodule
      src="https://unpkg.com/@vertexvis/poc-viewer@{{version}}/dist/viewer.js"
    ></script>
  </head>
</html>
```
